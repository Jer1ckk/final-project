...
public:
    ...
    void take_quiz(Quiz& quiz, int student_id, int subject_id) {
        quiz.read_data_from_history();
...
void student_menu(Quiz& math_quiz, Quiz& physic_quiz, int student_id) {
    ...
    do {
        ...
        switch (choice) {
            case 1: {
                math_quiz.take_quiz(math_quiz , student_id , 1);
                break;
            }
            case 2: {
                physic_quiz.take_quiz(physic_quiz , student_id , 2);
                break;
            }
            case 3: {
                cout << "\n===== My Scores =====" << endl;
                math_quiz.display_student_scores(student_id);
                physic_quiz.display_student_scores(student_id);
                break;
            }
            case 4:
                cout << "Logging out...\n" << endl;
